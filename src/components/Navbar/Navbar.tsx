      ...
      <div className="flex flex-col md:flex-row items-center justify-center">
        <div className="order-2 md:order-1 md:mr-4 text-center md:text-left">
          ...
          <p className="text-sm sm:text-base md:text-base lg:text-lg xl:text-lg mt-2 text-gray-300">
            I work every day to become a better human being. I like to build and learn things that interest me. I&aposm mainly interested in technology topics, but I&aposm interested in much more than that. I hope that one day I will see myself as the human I want to be.
          </p>
